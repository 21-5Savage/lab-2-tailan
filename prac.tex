...
\begin{itemize}
    \item \textbf{threshold\_value}: Босго. 
...
\begin{itemize}
    \item \textbf{bit\_position}: Ялгах битийн оршиж буй муж (0-7). Bit 0 нь хамгийн баруун бит (LSB), Bit 7 нь хамгийн зүүн бит (MSB).
    
    \item \textbf{img[i, j] >> bit\_position}: Битийu баруун тийш шилжүүлэх үйлдэл. Пикселийн утгыг баруун тийш bit\_position удаа шилжүүлж, хэрэгтэй битийг хамгийн баруун байрлалд авчирна.
