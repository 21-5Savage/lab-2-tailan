\section{Intensity quantization}
\label{sec:intensity}
...
\end{figure}
\footnotetext{Source: Digital Image Processing (Gonzalez \& Woods), Chapter 2, Figure 2.21(a)}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \caption{Эх зураг (бүдэг)\footnotemark}
...
\end{figure}
\footnotetext{Source: Digital Image Processing (Gonzalez \& Woods), Chapter 3, Figure 3.10(b)}
...
\begin{figure}[htbp]
  ...
  \caption{Local contrast хийж сайжруулсан үр дүн. }
  \label{fig:local_enhance}
\end{figure}
\footnotetext{Source: Digital Image Processing (Gonzalez \& Woods), Chapter 3, Figure 3.26(a)}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    ...
    \caption{Mask\footnotemark[\value{footnote}].}
    \label{fig:mask}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.32\textwidth}
    ...
    \caption{Einstein (high contrast)\footnotemark.}
    \label{fig:einstein}
  \end{subfigure}
...
\end{figure}
\footnotetext{Source: Digital Image Processing (Gonzalez \& Woods), Chapter 4, Figure 4.24(a)}
\footnotetext{Source: Digital Image Processing (Gonzalez \& Woods), Chapter 2, Figure 2.41(c)}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.30\textwidth}
    ...
    \caption{Эх зураг (salt-pepper noise)\footnotemark}
  ...
  \label{fig:median}
\end{figure}
\footnotetext{Source: Digital Image Processing (Gonzalez \& Woods), Chapter 3, Figure 3.35(a)}
...
\begin{figure}[htbp]
  ...
  \label{fig:laplacian}
\end{figure}
\footnotetext{Source: Digital Image Processing (Gonzalez \& Woods), Chapter 3, Figure 3.38(a)}
...
Sobel оператор нь нэг дүгээр зэргийн уламжлал (gradient) ашиглан ирмэг илрүүлдэг. Зураг \ref{fig:sobel}-д Sobel edge detection-ийн үр дүнг харуулав.

\begin{figure}[htbp]
  \centering
  \begin{subfigure}[b]{0.40\textwidth}
    \centering
    \includegraphics[width=\linewidth]{Fig0343(a)(skeleton_orig).png}
    \caption{Эх зураг\footnotemark}
...
\hfill
  \begin{subfigure}[b]{0.30\textwidth}
    \centering
    \includegraphics[width=\linewidth]{extra_sharp.png}
    \caption{Сайжруулсан зураг 1-р алхам}
    \label{fig:sobel_orig}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.30\textwidth}
    \centering
    \includegraphics[width=\linewidth]{sharp_k3.png}
    \caption{Сайжруулсан зураг 2-р алхам}
    \label{fig:sobel_orig}
  \end{subfigure}
  \caption{Sobel оператор ашиглан ирмэг илрүүлсэн үр дүн. Объектын хил, хэлбэр тодорхой илэрч байна.}
  \label{fig:sobel}
\end{figure}
\footnotetext{Source: Digital Image Processing (Gonzalez \& Woods), Chapter 3, Figure 3.43(a)}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.28\textwidth}
    \centering
    \includegraphics[width=\linewidth]{Fig0464(a)(car_75DPI_Moire).png}
    \caption{Эх зураг (periodic noise)\footnotemark}
  ...
  \label{fig:notch}
\end{figure}
\footnotetext{Source: Digital Image Processing (Gonzalez \& Woods), Chapter 4, Figure 4.64(a)}
